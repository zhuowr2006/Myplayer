...
//        mLoadMoreString = context.getString(R.string.loading);
    ...
    public void onDrawLoadMore(Canvas c, RecyclerView parent) {
        ...
        paint.setColor(Color.TRANSPARENT);// 画笔为灰色
        ...
        paint.setColor(Color.parseColor("#efc1d9"));// 设置画笔为绿色
        ...
        paint.reset();// 将画笔重置
        paint.setStrokeWidth(10);// 再次设置画笔的宽度
        paint.setTextSize(18);// 设置文字的大小
