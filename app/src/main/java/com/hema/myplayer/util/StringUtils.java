...
public class StringUtils {
	...
	/**
	 * is null or its length is 0 or it is made by spaceObjectUtils.java
	 * 
	 * <pre>
	 * isBlank(null) = true;
	 * isBlank(&quot;&quot;) = true;
	 ...
	 * @author wgs
	 * @param 改变价格显示
	 *            ￥符号及小数点后缩小字体(必须带小数点)AbsoluteSizeSpan(11,
	 *            true)，传true代表单位为dp否则为像素;第二、三个参数如下传的0,1(代表从下标0开始到1结束 不包括1)
	 * @return
	 */
